...
if args.num_steps == 100:
    ...
    loaded_dict_linf = torch.load(vec_dir_dim+"TRADES-Noise"+str(args.noise_dist)+"_NoisePW"+str(math.floor(args.noise_pw))+"Basis-"+str(args.noise_shp_basis)+"_SmoothPGDRestarts_linfAttack_Steps"+str(args.num_steps)+"_ErrVecs.pt")
    ...
    loaded_dict_l2 = torch.load(vec_dir_dim+"TRADES-Noise"+str(args.noise_dist)+"_NoisePW"+str(math.floor(args.noise_pw))+"Basis-"+str(args.noise_shp_basis)+"_SmoothPGDRestarts_l2Attack_Steps"+str(args.num_steps)+"_ErrVecs.pt")
    ...
    loaded_dict_l1 = torch.load(vec_dir_dim+"TRADES-Noise"+str(args.noise_dist)+"_NoisePW"+str(math.floor(args.noise_pw))+"Basis-"+str(args.noise_shp_basis)+"_SmoothPGDRestarts_l1Attack_Steps"+str(args.num_steps)+"_ErrVecs.pt")
    ...
    accuracy_list_file = open(res_dir_dim+"TRADES-Noise"+str(args.noise_dist)+"_NoisePW"+str(math.floor(args.noise_pw))+"Basis-"+str(args.noise_shp_basis)+"_SmoothPGD_Union_Robust_acc.txt","a")
